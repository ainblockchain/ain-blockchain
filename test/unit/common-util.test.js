...
describe("CommonUtil", () => {
  ...
  describe('getObjectHeightAndSize', () => {
    it('when non-object', () => {
      assert.deepEqual(CommonUtil.getObjectHeightAndSize(null), { height: 0, size: 0 });
      assert.deepEqual(CommonUtil.getObjectHeightAndSize(undefined), { height: 0, size: 0 });
      assert.deepEqual(CommonUtil.getObjectHeightAndSize(1), { height: 0, size: 0 });
      assert.deepEqual(CommonUtil.getObjectHeightAndSize(''), { height: 0, size: 0 });
      assert.deepEqual(CommonUtil.getObjectHeightAndSize('123'), { height: 0, size: 0 });
      assert.deepEqual(CommonUtil.getObjectHeightAndSize([]), { height: 0, size: 0 });
    });
    ...
    it('when non-empty object', () => {
      assert.deepEqual(CommonUtil.getObjectHeightAndSize({ a: 'a' }), { height: 1, size: 1 });
      assert.deepEqual(CommonUtil.getObjectHeightAndSize({
        a: {
          a: 'aa'
        }
      }), { height: 2, size: 2 });
