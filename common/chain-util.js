...
class ChainUtil {
  ...
  static returnTxResult(code, message = null, receipt = null) {
    const result = { code };
    if (message) {
   ...
   */
  static logAndReturnTxResult(logger, code, message = null, level = 1, receipt = null) {
    if (level === 0) {
    ...
    return ChainUtil.returnTxResult(code, message, receipt);
  }
