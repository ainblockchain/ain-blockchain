...
2026-09-11 M1 정정: 기존 `m1-sharding.js`의 논리 경로 개수는 실제 학습/프로토콜 샤딩 증명이 아닙니다. 새 [native POA 샤드 절차](./native-shards/README.md)는 부모4+자식3+3 검증자, SDK 기록·부모 증명 및 단일 노드 장애 복구를 검증합니다. 실제 학습70개·대규모 데이터 요구사항은 별도 미완료입니다.
