...
## Native POA shard verification

See [native-shards/README.md](native-shards/README.md) for independent parent/child state proofs and node recovery. Logical path counts alone do not prove protocol sharding or simultaneous GPU training.
