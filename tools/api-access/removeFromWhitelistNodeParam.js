...
async function removeFromWhitelistNodeParam(endpointUrl, chainId, param, value, accountType, keystoreFilepath) {
...
async function processArguments() {
  ...
  await removeFromWhitelistNodeParam(endpointUrl, chainId, param, value, accountType, keystoreFilepath);
}

function usage() {
  console.log('\nUsage: node removeFromWhitelistNodeParam.js <Endpoint Url> <Chain Id> <Param> <Value> <Account Type> [<Keystore Filepath>]\n');
  console.log('Example: node tools/api-access/removeFromWhitelistNodeParam.js http://localhost:8081 0 DEV_CLIENT_API_IP_WHITELIST 127.0.0.1 private_key');
