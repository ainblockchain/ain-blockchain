...
function buildOpenCheckinTxBody(ainErc20Address, fromAddr, tokenAmount, checkinId) {
  ...
  const ref = `/checkin/requests/ETH/3/${ainErc20Address}/${fromAddr}/${checkinId}`;
...
async function sendTransaction() {
  ...
  const txBody = buildOpenCheckinTxBody(config.ainErc20Address, config.userAddr, config.tokenAmount, config.checkinId);
