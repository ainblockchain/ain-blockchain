const JSON_RPC_METHODS = {
  ...
  AIN_DEPLOYMENT_DEPLOY: 'ain_deployment_deploy',
  AIN_DEPLOYMENT_STATUS: 'ain_deployment_status',
  AIN_DEPLOYMENT_STOP: 'ain_deployment_stop',
  AIN_DEPLOYMENT_LOGS: 'ain_deployment_logs',
  AIN_DEPLOYMENT_AUTHORIZE: 'ain_deployment_authorize',
  AIN_DEPLOYMENT_LIST: 'ain_deployment_list',
}
...
const JSON_RPC_SET_METHOD_SET = new Set([
  ...
  JSON_RPC_METHODS.AIN_DEPLOYMENT_DEPLOY,
  JSON_RPC_METHODS.AIN_DEPLOYMENT_STOP,
  JSON_RPC_METHODS.AIN_DEPLOYMENT_AUTHORIZE,
]);
