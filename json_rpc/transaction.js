...
module.exports = function getTransactionApis(node, p2pServer) {
  return {
    [JSON_RPC_METHOD.AIN_GET_PENDING_TRANSACTIONS]: function(args, done) {
    ...
    [JSON_RPC_METHOD.AIN_GET_TRANSACTION_POOL_SIZE_UTILIZATION]: function(args, done) {
      const beginTime = Date.now();
    ...
    [JSON_RPC_METHOD.AIN_GET_TRANSACTION_BY_HASH]: function(args, done) {
      const beginTime = Date.now();
    ...
    [JSON_RPC_METHOD.AIN_GET_TRANSACTION_BY_BLOCK_HASH_AND_INDEX]: function(args, done) {
      const beginTime = Date.now();
      let result = null;
    ...
    [JSON_RPC_METHOD.AIN_GET_TRANSACTION_BY_BLOCK_NUMBER_AND_INDEX]: function(args, done) {
      const beginTime = Date.now();
      let result = null;
    ...
    [JSON_RPC_METHOD.AIN_SEND_SIGNED_TRANSACTION]: function(args, done) {
      const beginTime = Date.now();
    ...
    [JSON_RPC_METHOD.AIN_SEND_SIGNED_TRANSACTION_BATCH]: function(args, done) {
      const beginTime = Date.now();
