...
const ENV_VARIABLES = [
  {
    ...
    BLOCKCHAIN_CONFIGS_DIR: 'blockchain-configs/1-node', ACCOUNT_INDEX: 0, HOSTING_ENV: 'local',
  ...
  },
  {
    ...
    PORT: 9090, P2P_PORT: 6000, HOSTING_ENV: 'local',
    CONSOLE_LOG: false
  },
  {
    BLOCKCHAIN_CONFIGS_DIR: 'blockchain-configs/he-shard',
    PORT: 9091, P2P_PORT: 6001, ENABLE_EXPRESS_RATE_LIMIT: false,
    ACCOUNT_INDEX: 0, PEER_CANDIDATE_JSON_RPC_URL: '', HOSTING_ENV: 'local',
    CONSOLE_LOG: false, ENABLE_DEV_CLIENT_SET_API: true, ENABLE_GAS_FEE_WORKAROUND: true,
  },
  {
    BLOCKCHAIN_CONFIGS_DIR: 'blockchain-configs/he-shard',
    PORT: 9092, P2P_PORT: 6002, HOSTING_ENV: 'local',
    ACCOUNT_INDEX: 1, ENABLE_EXPRESS_RATE_LIMIT: false,
    CONSOLE_LOG: false, ENABLE_DEV_CLIENT_SET_API: true, ENABLE_GAS_FEE_WORKAROUND: true,
  },
  {
    BLOCKCHAIN_CONFIGS_DIR: 'blockchain-configs/he-shard',
    PORT: 9093, P2P_PORT: 6003, HOSTING_ENV: 'local',
