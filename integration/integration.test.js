...
// Data options
RANDOM_OPERATION = [
  ['set_value', {data: {ref: 'test/comeonnnnnnn', value: 'testme'}}],
  ['set_value', {data: {ref: 'test/comeonnnnnnn', value: 'no meeeee'}}],
  ['set_value', {data: {ref: 'test/comeon/nnnnnn', value: 'through'}}],
  ['set_value', {data: {ref: 'test/comeonnnnnnn/new', value: {'new': 'path'}}}],
  ['set_value', {data: {ref: 'test/builed/some/deep', value: {'place': {'next': 1, 'level': 'down'}}}}],
  ['set_value', {data: {ref: 'test/builed/heliii', value: {'range': [1, 2, 3, 1, 4, 5]}}}],
  ['set_value', {data: {ref: 'test/b/u/i/l/e/d/hel', value: {'range': [1, 4, 5], 'another': [234]}}}],
  ['set_value', {data: {ref: 'test/b/u/i/l/e/d/hel', value: 'very nested'}}],
  ['set_value', {data: {ref: 'test/b/u/i/l/e/d/hel', value: {1: 2, 3: 4, 5: 6}}}],
  ['set_value', {data: {ref: 'test/new/final/path', value: {'neste': [1, 2, 3, 4, 5]}}}],
  ['set_value', {data: {ref: 'test/new/final/path', value: {'more': {'now': 12, 'hellloooo': 123}}}}],
  ['inc_value', {data: {ref: 'test/increase/first/level', value: 10}}],
  ['inc_value', {data: {ref: 'test/increase/second/level/deeper', value: 20}}],
  ['inc_value', {data: {ref: 'test/increase', value: 1}}],
  ['inc_value', {data: {ref: 'test/new', value: 1}}],
  ['inc_value', {data: {ref: 'test/increase', value: -10000}}],
  ['inc_value', {data: {ref: 'test/b/u', value: 10000}}],
  ['inc_value', {data: {ref: 'test/builed/some/deep/place/next', value: 100002}}],
  ...
  ['batch', {batch_list: [{op: 'set_value', data: {ref: 'test/comeonnnnnnn', value: 'testme'}}, {op: 'inc_value', data: {ref: 'test/b/u', value: 10000}}]}],
  ['batch', {batch_list: [{op: 'set_value', data: {ref: 'test/comeonnnnnnn', value: 'no meeeee'}}]}],
  ['batch', {batch_list: [{op: 'set_value', data: {ref: 'test/comeon/nnnnnn', value: 'through'}}]}],
  ['batch', {batch_list: [{op: 'set_value', data: {ref: 'test/comeonnnnnnn/new', value: {'new': 'path'}}}]}],
  ['batch', {batch_list: [{op: 'set_value', data: {ref: 'test/builed/some/deep', value: {'place': {'next': 1, 'level': 'down'}}}}]}],
  ['batch', {batch_list: [{op: 'set_value', data: {ref: 'test/builed/heliii', value: {'range': [1, 2, 3, 1, 4, 5]}}}]}],
  ['batch', {batch_list: [{op: 'set_value', data: {ref: 'test/b/u/i/l/e/d/hel', value: {'range': [1, 4, 5], 'another': [234]}}}]}],
  ['batch', {batch_list: [{op: 'set_value', data: {ref: 'test/b/u/i/l/e/d/hel', value: 'very nested'}}]}],
  ['batch', {batch_list: [{op: 'set_value', data: {ref: 'test/b/u/i/l/e/d/hel', value: {1: 2, 3: 4, 5: 6}}}]}],
  ['batch', {batch_list: [{op: 'set_value', data: {ref: 'test/new/final/path', value: {'neste': [1, 2, 3, 4, 5]}}}]}],
];
