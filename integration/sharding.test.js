...
const ENV_VARIABLES = [
  {
    ...
    ACCOUNT_INDEX: 0, PEER_CANDIDATE_JSON_RPC_URL: '', DEBUG: true, HOSTING_ENV: 'local',
    CONSOLE_LOG: false, ENABLE_DEV_CLIENT_SET_API: true, ENABLE_GAS_FEE_WORKAROUND: true,
  },
  {
    // For shard chain tracker
    PORT: 9000, P2P_PORT: 6000, CONSOLE_LOG: false, HOSTING_ENV: 'local',
  },
  {
    BLOCKCHAIN_CONFIGS_DIR: 'blockchain-configs/afan-shard',
    PORT: 9001, P2P_PORT: 6001, PEER_CANDIDATE_JSON_RPC_URL: '', HOSTING_ENV: 'local',
    ACCOUNT_INDEX: 0, ENABLE_EXPRESS_RATE_LIMIT: false,
    CONSOLE_LOG: false, ENABLE_DEV_CLIENT_SET_API: true, ENABLE_GAS_FEE_WORKAROUND: true,
  },
  {
    BLOCKCHAIN_CONFIGS_DIR: 'blockchain-configs/afan-shard',
    PORT: 9002, P2P_PORT: 6002, HOSTING_ENV: 'local',
    ACCOUNT_INDEX: 1, ENABLE_EXPRESS_RATE_LIMIT: false,
    CONSOLE_LOG: false, ENABLE_DEV_CLIENT_SET_API: true, ENABLE_GAS_FEE_WORKAROUND: true,
  },
  {
    BLOCKCHAIN_CONFIGS_DIR: 'blockchain-configs/afan-shard',
    PORT: 9003, P2P_PORT: 6003, HOSTING_ENV: 'local',
