...
```
CONSOLE_LOG=true HOSTING_ENV=local MIN_NUM_VALIDATORS=3 ACCOUNT_INDEX=0 DEBUG=false STAKE=250 ENABLE_DEV_CLIENT_API=true node client/index.js
CONSOLE_LOG=true HOSTING_ENV=local MIN_NUM_VALIDATORS=3 ACCOUNT_INDEX=1 DEBUG=false STAKE=250 ENABLE_DEV_CLIENT_API=true node client/index.js 
CONSOLE_LOG=true HOSTING_ENV=local MIN_NUM_VALIDATORS=3 ACCOUNT_INDEX=2 DEBUG=false STAKE=250 ENABLE_DEV_CLIENT_API=true node client/index.js
```
You can override default port numbering system by setting `PORT` and `P2P_PORT` environment variables.
...
```
GENESIS_CONFIGS_DIR=genesis-configs/afan-shard CONSOLE_LOG=true HOSTING_ENV=local MIN_NUM_VALIDATORS=1 ACCOUNT_INDEX=0 DEBUG=false STAKE=250 NABLE_DEV_CLIENT_API=true node client/index.js
```
