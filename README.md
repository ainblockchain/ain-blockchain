...
```
NUM_VALIDATORS=5 ACCOUNT_INDEX=0 HOSTING_ENV=local DEBUG=false node client/index.js
NUM_VALIDATORS=5 ACCOUNT_INDEX=1 HOSTING_ENV=local DEBUG=false node client/index.js 
NUM_VALIDATORS=5 ACCOUNT_INDEX=2 HOSTING_ENV=local DEBUG=false node client/index.js 
NUM_VALIDATORS=5 ACCOUNT_INDEX=3 HOSTING_ENV=local DEBUG=false node client/index.js 
NUM_VALIDATORS=5 ACCOUNT_INDEX=4 HOSTING_ENV=local DEBUG=false node client/index.js 
```
