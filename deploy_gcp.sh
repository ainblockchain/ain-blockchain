...
FILES_FOR_NODE="blockchain/ client/ common/ consensus/ db json_rpc genesis-configs/ logger/ node/ package.json setup_node_gcp.sh setup_ubuntu.sh start_node_gcp.sh tx-pool/ p2p/"
