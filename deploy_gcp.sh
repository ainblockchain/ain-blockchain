...
FILES_FOR_TRACKER="blockchain/ common/ consensus/ db/ genesis-configs/ logger/ tracker-server/ package.json setup_tracker_gcp.sh setup_ubuntu.sh start_tracker_gcp.sh"
