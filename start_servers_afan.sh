...
sleep 5
ACCOUNT_INDEX=0 CONSOLE_LOG=true ENABLE_DEV_CLIENT_API=true ENABLE_GAS_FEE_WORKAROUND=true node ./client/index.js &
sleep 5
ACCOUNT_INDEX=1 CONSOLE_LOG=true ENABLE_DEV_CLIENT_API=true ENABLE_GAS_FEE_WORKAROUND=true node ./client/index.js &
sleep 5
ACCOUNT_INDEX=2 CONSOLE_LOG=true ENABLE_DEV_CLIENT_API=true ENABLE_GAS_FEE_WORKAROUND=true node ./client/index.js &
sleep 15
