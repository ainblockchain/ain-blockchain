...
PID1=$!
sleep 5
STAKE=250 LOCAL=true node $BASEDIR/../client/index.js > $BASEDIR/log1.txt &
PID2=$!
sleep 10
STAKE=250 P2P_PORT=5020 PORT=8081 HOSTING_ENV=local node $BASEDIR/../client/index.js > $BASEDIR/log2.txt &
PID3=$!
