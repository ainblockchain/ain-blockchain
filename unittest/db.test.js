    ...
    describe("setFunction", () => {
      it("when overwriting existing function config with simple path", () => {
        const functionConfig = {
          ".function": {
            "fid": {
              "event_listener": "http://echo-bot.ainetwork.ai/trigger",
              "function_id": "fid",
              "function_type": "REST",
            }
          }
        ...
        assert.deepEqual(node.db.getFunction("/apps/test/test_function/some/path"), {
          ".function": {
            "fid": {
              "event_listener": "http://echo-bot.ainetwork.ai/trigger",  // modified
              "function_id": "fid",
              "function_type": "REST",
            }
          },
  ...
  describe("Transaction execution", () => {
    ...
    describe("executeTransaction", () => {
      ...
      it('cannot exceed service state budget', () => {
        ...
        assert.deepEqual(res.error_message, "Exceeded state budget limit for services (11300820 > 10000000)");
    ...
    const funcChange = {
      ".function": {
        "fid": {
          "function_type": "REST",
          "function_id": "fid",
          "event_listener": "http://echo-bot.ainetwork.ai/trigger",  // Listener 2
        },
      }
    };
    const newFunc = {
