...
describe("state-util", () => {
  ...
  describe("state info updates", () => {
    ...
    it("getStateProofFromStateRoot - general case", () => {
      updateStateInfoForStateTree(stateTree);
    ...
    it("getStateProofFromStateRoot - label conflict", () => {
      ...
      assert.deepEqual(verifyStateProof(proof), {
        ...
        "rootProofHash": "0x8c2734c83cbcdc673190a8d164892c1489f908b3f80d6068257753a39de16181",
      });
    });
