...
describe("state-node", () => {
  ...
  describe("fromJsObject with version / toJsObject", () => {
    ...
    it("internal node", () => {
      ...
      assert.deepEqual(StateNode.fromJsObject(stateObj, ver1).toJsObject({ includeStateProof: true }), {
        ".proofHash": null,
        ".proofHash:bool": null,
      ...
      assert.deepEqual(StateNode.fromJsObject(stateObj, ver1).toJsObject({ includeStateVersion: true }), {
        ".version": "ver1",
        ".version:bool": "ver1",
