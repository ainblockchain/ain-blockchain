...
# 1. Configure env vars (BLOCKCHAIN_CONFIGS_DIR, TRACKER_UPDATE_PEER_INFO_URL, ...)
printf "\n#### [Step 1] Configure env vars ####\n\n"

KEYSTORE_DIR=testnet_dev_staging_keys
if [[ $SEASON = 'spring' ]]; then
    export BLOCKCHAIN_CONFIGS_DIR=blockchain-configs/testnet-prod
    export TRACKER_UPDATE_PEER_INFO_URL=http://35.221.137.80:8080/update_peer_info
    export P2P_PEER_CANDIDATE_URL="http://35.221.184.48:8080/json-rpc"
    KEYSTORE_DIR=testnet_prod_keys
elif [[ $SEASON = 'summer' ]]; then
    export BLOCKCHAIN_CONFIGS_DIR=blockchain-configs/testnet-prod
    export TRACKER_UPDATE_PEER_INFO_URL=http://35.194.172.106:8080/update_peer_info
    ...
    if [[ $SHARD_INDEX = 0 ]]; then
        ...
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.187.153.22:8080/update_peer_info  # dev-shard-1-tracker-ip
    elif [[ $SHARD_INDEX = 2 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://34.80.203.104:8080/update_peer_info  # dev-shard-2-tracker-ip
    elif [[ $SHARD_INDEX = 3 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.189.174.17:8080/update_peer_info  # dev-shard-3-tracker-ip
    elif [[ $SHARD_INDEX = 4 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.221.164.158:8080/update_peer_info  # dev-shard-4-tracker-ip
    elif [[ $SHARD_INDEX = 5 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.234.46.65:8080/update_peer_info  # dev-shard-5-tracker-ip
    elif [[ $SHARD_INDEX = 6 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.221.210.171:8080/update_peer_info  # dev-shard-6-tracker-ip
    elif [[ $SHARD_INDEX = 7 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://34.80.222.121:8080/update_peer_info  # dev-shard-7-tracker-ip
    elif [[ $SHARD_INDEX = 8 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.221.200.95:8080/update_peer_info  # dev-shard-8-tracker-ip
    elif [[ $SHARD_INDEX = 9 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://34.80.216.199:8080/update_peer_info  # dev-shard-9-tracker-ip
    elif [[ $SHARD_INDEX = 10 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://34.80.161.85:8080/update_peer_info  # dev-shard-10-tracker-ip
    elif [[ $SHARD_INDEX = 11 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.194.239.169:8080/update_peer_info  # dev-shard-11-tracker-ip
    elif [[ $SHARD_INDEX = 12 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.185.156.22:8080/update_peer_info  # dev-shard-12-tracker-ip
    elif [[ $SHARD_INDEX = 13 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.229.247.143:8080/update_peer_info  # dev-shard-13-tracker-ip
    elif [[ $SHARD_INDEX = 14 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.229.226.47:8080/update_peer_info  # dev-shard-14-tracker-ip
    elif [[ $SHARD_INDEX = 15 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.234.61.23:8080/update_peer_info  # dev-shard-15-tracker-ip
    elif [[ $SHARD_INDEX = 16 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://34.80.66.41:8080/update_peer_info  # dev-shard-16-tracker-ip
    elif [[ $SHARD_INDEX = 17 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.229.143.18:8080/update_peer_info  # dev-shard-17-tracker-ip
    elif [[ $SHARD_INDEX = 18 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.234.58.137:8080/update_peer_info  # dev-shard-18-tracker-ip
    elif [[ $SHARD_INDEX = 19 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://34.80.249.104:8080/update_peer_info  # dev-shard-19-tracker-ip
    elif [[ $SHARD_INDEX = 20 ]]; then
        export TRACKER_UPDATE_PEER_INFO_URL=http://35.201.248.92:8080/update_peer_info  # dev-shard-20-tracker-ip
    else
    ...
    if [[ $SHARD_INDEX -gt 0 ]]; then
        ...
        data.blockchain.TRACKER_UPDATE_PEER_INFO_URL = '$TRACKER_UPDATE_PEER_INFO_URL';
...
printf "TRACKER_UPDATE_PEER_INFO_URL=$TRACKER_UPDATE_PEER_INFO_URL\n"
